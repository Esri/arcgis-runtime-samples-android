...
class MainActivity : AppCompatActivity() {
    ...
    private val resultFillSymbol = SimpleFillSymbol(SimpleFillSymbol.Style.SOLID, -0x16e0e1,
            lineSymbol)
    ...
    private fun createPolygons() {
        ...
        var fillSymbol = SimpleFillSymbol(SimpleFillSymbol.Style.SOLID, -0x66ffff34, lineSymbol)
        inputGeometryOverlay.getGraphics().add(Graphic(inputPolygon1, fillSymbol))
        ...
        fillSymbol = SimpleFillSymbol(SimpleFillSymbol.Style.SOLID, -0x66ff6700, lineSymbol)
        inputGeometryOverlay.getGraphics().add(Graphic(inputPolygon2, fillSymbol))
