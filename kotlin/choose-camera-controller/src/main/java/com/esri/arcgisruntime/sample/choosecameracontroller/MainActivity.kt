...
class MainActivity : AppCompatActivity() {
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    sceneOverlay.sceneProperties.surfacePlacement = LayerSceneProperties.SurfacePlacement.ABSOLUTE
        ...
        with(File(cacheDir.toString() + File.separator + filename)) {
          if (!this.exists()) {
            try {
              ...
              logToUser(getString(R.string.error_writing_to_cache, filename, e.message))
            }
          } else {
