...
class MainActivity : AppCompatActivity() {
    ...
    private val routeStartedListener: RouteTracker.RerouteStartedListener =
        RouteTracker.RerouteStartedListener {
            routeTracker?.removeTrackingStatusChangedListener(trackingStatusUpdated)
        }
    ...
    private val routeCompletedListener: RouteTracker.RerouteCompletedListener =
        RouteTracker.RerouteCompletedListener {
            ...
            val list = it.trackingStatus.routeResult.routes[0].directionManeuvers
            directionManeuvers.addAll(list)
            // Re-add the event listeners for tracking status changes
            routeTracker?.addTrackingStatusChangedListener(trackingStatusUpdated)
        }


    private val trackingStatusUpdated: RouteTracker.TrackingStatusChangedListener =
    ...
    private fun setUpMapRoute() {
        statusMessageTV.text = "Route overview"
        ...
        routeTask.addDoneLoadingListener {
            ...
            routeParametersFuture.addDoneListener {
                ...
                // create starting and destination stopsx
