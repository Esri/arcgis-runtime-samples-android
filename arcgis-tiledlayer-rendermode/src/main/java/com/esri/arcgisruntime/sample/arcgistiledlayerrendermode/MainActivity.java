      ...
      @Override public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        switch (progress) {
          case 0:
            ...
            mSeekBarScale.setText(getString(R.string.seekbar_scale, 5.91657527591555E8));
            break;
          case 1:
            mMapView.setViewpointScaleAsync(2.95828763795777E8);
            mSeekBarScale.setText(getString(R.string.seekbar_scale, 2.95828763795777E8));
            break;
          case 2:
            mMapView.setViewpointScaleAsync(1.47914381897889E8);
            mSeekBarScale.setText(getString(R.string.seekbar_scale, 1.47914381897889E8));
            break;
          case 3:
            mMapView.setViewpointScaleAsync(7.3957190948944E7);
            mSeekBarScale.setText(getString(R.string.seekbar_scale, 7.3957190948944E7));
            break;
          case 4:
            mMapView.setViewpointScaleAsync(3.6978595474472E7);
            mSeekBarScale.setText(getString(R.string.seekbar_scale, 3.6978595474472E7));
            break;
          case 5:
            mMapView.setViewpointScaleAsync(1.8489297737236E7);
            mSeekBarScale.setText(getString(R.string.seekbar_scale, 1.8489297737236E7));
            break;
          case 6:
            mMapView.setViewpointScaleAsync(9244648.868618);
            mSeekBarScale.setText(getString(R.string.seekbar_scale, 9244648.868618));
            break;
          case 7:
            mMapView.setViewpointScaleAsync(4622324.434309);
            mSeekBarScale.setText(getString(R.string.seekbar_scale, 4622324.434309));
            break;
          case 8:
            mMapView.setViewpointScaleAsync(2311162.217155);
            mSeekBarScale.setText(getString(R.string.seekbar_scale, 2311162.217155));
            break;
          case 9:
            mMapView.setViewpointScaleAsync(1155581.108577);
            mSeekBarScale.setText(getString(R.string.seekbar_scale, 1155581.108577));
            break;
          case 10:
            mMapView.setViewpointScaleAsync(577790.554289);
            mSeekBarScale.setText(getString(R.string.seekbar_scale, 577790.554289));
            break;
          case 11:
            mMapView.setViewpointScaleAsync(288895.277144);
            mSeekBarScale.setText(getString(R.string.seekbar_scale, 288895.277144));
            break;
          case 12:
            mMapView.setViewpointScaleAsync(144447.638572);
            mSeekBarScale.setText(getString(R.string.seekbar_scale, 144447.638572));
            break;
          case 13:
            mMapView.setViewpointScaleAsync(72223.819286);
            mSeekBarScale.setText(getString(R.string.seekbar_scale, 72223.819286));
            break;
          case 14:
            mMapView.setViewpointScaleAsync(36111.909643);
            mSeekBarScale.setText(getString(R.string.seekbar_scale, 36111.909643));
            break;
          case 15:
            mMapView.setViewpointScaleAsync(18055.954822);
            mSeekBarScale.setText(getString(R.string.seekbar_scale, 18055.954822));
            break;
          case 16:
            mMapView.setViewpointScaleAsync(9027.977411);
            mSeekBarScale.setText(getString(R.string.seekbar_scale, 9027.977411));
            break;
          case 17:
            mMapView.setViewpointScaleAsync(4513.988705);
            mSeekBarScale.setText(getString(R.string.seekbar_scale, 4513.988705));
            break;
          case 18:
            mMapView.setViewpointScaleAsync(2256.994353);
            mSeekBarScale.setText(getString(R.string.seekbar_scale, 2256.994353));
            break;
          case 19:
            mMapView.setViewpointScaleAsync(1128.497176);
            mSeekBarScale.setText(getString(R.string.seekbar_scale, 1128.497176));
            break;
          case 20:
            mMapView.setViewpointScaleAsync(564.248588);
            mSeekBarScale.setText(getString(R.string.seekbar_scale, 564.248588));
            break;
          case 21:
            mMapView.setViewpointScaleAsync(282.124294);
            mSeekBarScale.setText(getString(R.string.seekbar_scale, 282.124294));
            break;
          case 22:
            mMapView.setViewpointScaleAsync(141.062147);
            mSeekBarScale.setText(getString(R.string.seekbar_scale, 141.062147));
            break;
          case 23:
            mMapView.setViewpointScaleAsync(70.5310735);
            mSeekBarScale.setText(getString(R.string.seekbar_scale, 70.5310735));
            break;
        }
      }
    ...
    mMapView.addVisibleAreaChangedListener(new VisibleAreaChangedListener() {
      @Override public void visibleAreaChanged(VisibleAreaChangedEvent visibleAreaChangedEvent) {
        ...
        if (mapScale == 5.91657527591555E8){
          ...
          mSeekBarScale.setText(getString(R.string.seekbar_scale, 5.91657527591555E8));
        } else if (mapScale >= 2.95828763795777E8 && mapScale <= 5.91657527591555E8) {
          ...
          mMapScaleSeekBar.setProgress(23);
          mSeekBarScale.setText(getString(R.string.seekbar_scale, 70.5310735));
        }
      }
    });
