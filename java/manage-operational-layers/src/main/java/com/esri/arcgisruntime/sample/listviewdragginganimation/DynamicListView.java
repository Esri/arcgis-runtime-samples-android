...
public class DynamicListView extends ListView {
    ...
    public ArrayList<String> mItemsList;
    ...
    private void handleCellSwitch() {
        ...
        if (isBelow || isAbove) {
            ...
            swapElements(mItemsList, originalItem, getPositionForView(switchView));
    ...
    public void setLayerList(ArrayList<String> layerList) {
        mItemsList = layerList;
    }
