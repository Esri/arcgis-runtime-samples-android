...
public class MainActivity extends AppCompatActivity {
  ...
  private void setupOfflineMapGeocode() {
    ...
    TileCache tileCache = new TileCache(getExternalFilesDir(null)?.path + getString(R.string.san_diego_tpk));
    ...
    mLocatorTask = new LocatorTask(
        getExternalFilesDir(null)?.path + getResources().getString(R.string.san_diego_loc));
