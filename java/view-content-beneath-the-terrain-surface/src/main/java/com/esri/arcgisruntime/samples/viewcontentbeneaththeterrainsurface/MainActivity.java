package com.esri.arcgisruntime.samples.viewcontentbeneaththeterrainsurface;
        ...
        portalItem.addDoneLoadingListener(() -> {
          if (portalItem.getLoadStatus() == LoadStatus.LOADED) {
            ...
            scene.addDoneLoadingListener(() -> {
              ...
              scene.getBaseSurface().setNavigationConstraint(Surface.NavigationConstraint.NONE);
