...
public class ShowEditFeatures extends PopupWindow {
    Context context;
    ...
    public ShowEditFeatures(Context ctx, MapView map) {
        this.context = ctx;
        this.map = map;
    ...
    public View populateContentView() {
        ...
        templateGroup.setLayoutParams(new RelativeLayout.LayoutParams(android.view.ViewGroup.LayoutParams.MATCH_PARENT,
        ...
        for (Layer layer : map.getLayers()) {
            if (layer instanceof FeatureLayer) {
                ...
                templateLayout.setLayoutParams(new RelativeLayout.LayoutParams(android.view.ViewGroup.LayoutParams.MATCH_PARENT,
                        android.view.ViewGroup.LayoutParams.MATCH_PARENT));
                ...
                layerTemplate.setLayoutParams(new RelativeLayout.LayoutParams(android.view.ViewGroup.LayoutParams.WRAP_CONTENT,
    ...
    private void populateTemplateView(LinearLayout layerTemplate, Bitmap bitmap, final FeatureTemplate featureTemplate,
        ...
        templateAndType.setLayoutParams(new RelativeLayout.LayoutParams(android.view.ViewGroup.LayoutParams.WRAP_CONTENT,
                android.view.ViewGroup.LayoutParams.WRAP_CONTENT));
